...
client_id = 'e1ac9da1700e6a00396d234a24a682f9'
client_secret = 'E4472FD67B09B522945010E6D8385FE78B7D762199889203F70F8F27A2BA056A'
...
def manage_token():
    ...
    if not os.path.isfile('token.csv'):
        write_token()
        

    df = pd.read_csv('token.csv', parse_dates=["expiration"])
...
def manage_token_gen() -> str:
    """Compatibility wrapper used by test_gen_position."""
    return manage_token()
